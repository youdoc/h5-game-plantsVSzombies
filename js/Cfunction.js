...
InitGame = function() {
    ...
    a = $("dProcess"); ! $("dText1") && a.insertBefore(NewEle("dText1", "div", 0, {
        innerHTML: '<span style="line-height:23px;font-size:15px;font-family:&#x9ED1;&#x4F53;;color:#F60;top:32px">欢迎体验<span style="font-family:Verdana;font-weight:700">新版植物大战僵尸JS</span>,程序是玩家自制,与任何盈利公司无关。'
    },
    0), a.firstChild);
   // LoadLvl();
   LoadLvl();
